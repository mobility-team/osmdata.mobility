...
output: 
    html_document:
        ...
        theme: flatly
vignette: >
  %\VignetteIndexEntry{1. osmdata.mobility}
...
`osmdata.mobility` can be installed from Mobility R-universe with
```{r, eval = FALSE}
install.packages(
    "osmdata.mobility",
...
```
The development version of `osmdata.mobility` can be installed with the `remotes`
