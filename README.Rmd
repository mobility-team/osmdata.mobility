...
Mobility workflows. The current code change keeps file-based Overpass XML input
available as raw XML text after validation, which lets downstream Mobility code
reuse the exact downloaded OSM XML payload.
